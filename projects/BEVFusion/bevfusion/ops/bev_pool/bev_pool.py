...
try:
    from unum_ops.bev_pool import bev_pool as _bev_pool_ascend, bev_pool_torch as _bev_pool_ascend_torch
...
def bev_pool(feats, coords, B, D, H, W):
    ...
    if _bev_pool_ascend is not None:
        return _bev_pool_ascendc(feats, coords, B, D, H, W)
    if _HAS_MX_DRIVING_EXT:
        return _bev_pool_mxdriving(feats, coords, B, D, H, W)
    return _bev_pool_pytorch(feats, coords, B, D, H, W)
